const book_data = [{
  ...
  pages: [
    ...
    "<div style=\"width:341px; height:536px; display: flex;justify-content: center;align-items: center;\"><img src=\"https://birckk.com/wp-content/uploads/portfolio/Universe/Books/GodSword/god-sword.png\" alt=\"\" style=\"width:150%; \"></div>",
  ],
  //x, y, w, h
  pos: [340, 535, 35, 75]
},
{
  ...
  pages: [
    ...
    "<div style=\"width:341px; height:536px; display: flex;justify-content: center;align-items: center;\"><img src=\"https://birckk.com/wp-content/uploads/portfolio/Universe/Books/PlantBook/flower1.png\" alt=\"\" style=\"width:150%; \"></div>",
    ...
    "<div style=\"width:341px; height:536px; display: flex;justify-content: center;align-items: center;\"><img src=\"https://birckk.com/wp-content/uploads/portfolio/Universe/Books/PlantBook/flower2.png\" alt=\"\" style=\"width:150%; \"></div>"
  ],
  //x, y, w, h
  pos: [115, 260, 30, 70]
},
{
  ...
  pages: [
    ...
    "<div style=\"width:341px; height:536px; display: flex;justify-content: center;align-items: center;\"><img src=\"https://birckk.com/wp-content/uploads/portfolio/Universe/Books/Artisans/artisans-chandler.png\" alt=\"\" style=\"width:250%; \"></div>",
  ],
  //x, y, w, h
  pos: [165, 80, 30, 60]
}
